var content = document.querySelector('div.header_canvas');
var image = document.querySelector('img.canvas');
...
function start() {
  ...
  content.appendChild(imageCanvas);
  resizeCanvases();
  tick();
}
...
function resizeCanvases() {
  imageCanvas.width = lineCanvas.width = content.clientWidth;
  imageCanvas.height = lineCanvas.height = content.offsetHeight;
}
